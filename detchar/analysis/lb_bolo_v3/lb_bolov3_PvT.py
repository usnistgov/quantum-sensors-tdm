...
def main():
    ...
    fnames = [#'lbird_bolov3_ColumnA_ivs_20220112_1642023025.json', # suspect that battery box might have died near end
              ...
              #'lbird_bolov3_ColumnA_ivs_20220125_1643131132.json', # this (and all previous) used positive IV bias which cut Psat in half
    ...
    outpath = os.path.join(path,'lb_bolov3_PvT_output_20220322_allCol_newIVutils')
