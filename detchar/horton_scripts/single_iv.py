...
curve_taker = detchar.IVCurveTaker(
    detchar.IVPointTaker("DB1", "CX", column_number=0, delay_s=.05),
...
# curve_taker.set_temp_and_settle(setpoint_k=55 * 1e-3)
curve_taker.prep_fb_settings(I=10, fba_offset=8000, ARLoff=False)
# curve_taker.prep_fb_settings(I=60, fba_offset=3500, ARLoff=True)
dacs = detchar.sparse_then_fine_dacs(a=4000, b=2000, c=0, n_ab=150, n_bc=50)
# dacs = np.arange(40000, 39000,-50)
# ZERO_V = 26214
