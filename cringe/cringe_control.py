...
CRINGE_COMMANDS = {
    ...
    "set_tower_channel": {
        "fname": "rpc_set_tower_channel",
        "args": ["cardname", "bayname", "dacvalue"],
        "help": "set the dac value for a tower card by cardname and bayname (strings)",
    },
...
class CringeControl:
    ...
    def __init__(self, host="localhost"):
        ...
        self.socket.RCVTIMEO = 30000  # milliseconds
        self.socket.SNDTIMEO = 30000  # milliseconds
    ...
    def set_tower_channel(self, cardname, bayname, dacvalue):
        return self.send(
            " ".join(("set_tower_channel", cardname, bayname, str(int(dacvalue))))
        )
    ...
    def set_fba_offset(self, col, fba_offset):
        return self.send(
            " ".join(("set_fba_offset", str(int(col)), str(int(fba_offset))))
        )
