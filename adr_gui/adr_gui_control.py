...
ADR_GUI_COMMANDS = {
    "get_temp_k": {
        "fname": "rpc_get_temp_k",
        "args": None,
        "help": "return the most recent FAA temp reading in kelvin",
    },
    "set_temp_k": {
        "fname": "rpc_set_temp_k",
        "args": ["setpoint_k"],
        "help": "works in control mode only, set the control loop temperature setpoint in kelvin",
    },
    "get_temp_rms_uk": {
        "fname": "rpc_get_temp_rms_uk",
        "args": None,
        "help": "temp temperature stability rms",
    },
    "get_slope_hout_per_hour": {
        "fname": "rpc_get_slope_hout_per_hour",
        "args": None,
        "help": "return the heater change per hour slope",
    },
    "get_hout": {
        "fname": "rpc_get_hout",
        "args": None,
        "help": "return the heater out value",
    },
    "echo": {
        "fname": "rpc_echo",
        "args": ["x"],
        "help": "return the string representation of x, for testing",
    },
}
...
class AdrGuiControl:
    ...
    def __init__(self, host="localhost"):
        ...
        self.socket.RCVTIMEO = 1000  # milliseconds
        self.socket.SNDTIMEO = 1000  # milliseconds
